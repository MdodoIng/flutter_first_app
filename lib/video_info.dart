...
import 'package:firest_app/colors.dart';
...
class _VideoInfoState extends State<VideoInfo> {
  ...
  void _videoListener() {
    ...
    if (curPosition.toString() != "0;00;00.00000" &&
  ...
  Widget _controlView(BuildContext context) {
    final onMote = (_controller?.value.volume ?? 0) > 0;
    return Column(
              ...
              InkWell(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      onMote ? Icons.volume_up : Icons.volume_off,
                      color: Colors.white,
                    ),
                  ),
                ),
...
class Video {
  ...
  Video({this.title, this.time, this.thumbnail, this.videoUrl});
